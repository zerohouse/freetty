app.directive('smoothScroll', function ($log, $timeout, $window) {
        /*
        ...
        smoothScroll = function (eID, offSet) {
            ...
            var scope = angular.element(document.getElementById(eID)).scope();
            scope.scrolling = true;

            var scrollingFalse = function () {
            ...
            if (stopY > startY) {
                ...
                $timeout.cancel(scrollingFalse);
                $timeout(scrollingFalse, 100);
                return;
            }
            i = startY;
            _results = [];
